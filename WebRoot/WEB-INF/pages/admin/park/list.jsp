...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-list"></span> 停车收费
                    </div>
   ...
   <span class="label label-success">    
    ...
    <span class="label label-danger">        
      ...
      href="<%=basePath%>park/park/edit?state=2&ret=list&id=${u.id}">
     	驶离
     </a>	
     </c:if>
     ...
     <a class="am-btn am-btn-danger" href="<%=basePath%>park/park/delete?id=${u.id}&ret=list">
     	取消  	
     </a>
      </td>
      </tr>
