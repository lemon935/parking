...
<body>
              ...
              <div class="admin-content am-u-lg-6 am-cf am-padding am-padding-bottom-0" style="padding:15px;">
                ...
                <div class="big-box">
                  <div class="col-lg-6">
                    ...
                    <form method="POST"  action="<%=basePath%>autocar/autocar/update">
           ...
           <h4>             
                      ...
                      <div class="card-body">
                           ...
                           <div class="form">
                          <p>备注</p>            <input type="hidden" name="id" value="${model.id }"/>                
                          <input name="title" class="form-control"  required value="${model.title }" type="text" placeholder="" >
                        </div>
                      
                        <div class="form">
                          <p>区域</p>                          
                          <input name="carno" class="form-control"  required value="${model.carno }" type="text" placeholder="" >
                        </div>
                          <div class="form">
                          <p>停车位</p>                          
                          <input name="seats" class="form-control"  required value="${model.seats }" type="text" placeholder="" >
                        </div>
                         ...
                         <div class="form">
                          <p>开始</p>                          
                          <input name="color" class="form-control" required value="${model.color }" type="text" placeholder="" >
                        </div>
